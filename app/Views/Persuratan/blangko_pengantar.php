...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Blangko Surat Pengantar</h1>
    </div>
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            ...
            <form action="<?= base_url('pengantar/print'); ?>" method="POST" class="user">
                <?= csrf_field(); ?>
                ...
                <div class="form-step">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="isi_tambahan" id="isi_tambahan" cols="3" rows="5"></textarea>
                    </div>
                ...
                <div class="form-step">
                    ...
                    <input type="hidden" class="form-control" name="perihal" id="perihal" value="Pengantar">
                    <br>
                    <div class="text-right">
                        <a class="btn btn-light btn-prev">Previous</a>
